...
<td><b>Meaning:</b> Inference engine.<br/><b>Description:</b> Supports <code>paddle</code> and <code>paddle_dynamic</code>. If left as <code>None</code> (the default), PaddleOCR preserves the behavior of earlier versions, which in most configurations is equivalent to <code>paddle</code>. For detailed descriptions, supported values, compatibility rules, and examples, see <a href="../inference_engine.en.md">Inference Engine and Configuration</a>.</td>
<td><code>str</code></td>
<td></td>
</tr>
<tr>
