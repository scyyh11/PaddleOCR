...
3. **希望将 PaddleOCR-VL 部署为 API 服务**：
    ...
    此外，如果您需要支持并发请求处理，我们还提供了基于 FastAPI 网关 + Triton + vLLM 的[高性能服务化部署方案](https://github.com/PaddlePaddle/PaddleOCR/blob/main/deploy/paddleocr_vl_docker/hps/README.md)，适合对吞吐量有较高要求的生产环境。
